...
class Properties
{
    ...
    public function readCoreProperties(string $propertyData): void
    {
        ...
        if (is_object($xmlCore)) {
            ...
            $this->docProps->setCreated($this->getArrayItem($xmlCore->xpath('dcterms:created')));             $this->docProps->setModified($this->getArrayItem($xmlCore->xpath('dcterms:modified')));             $this->docProps->setTitle($this->getArrayItem($xmlCore->xpath('dc:title')));
