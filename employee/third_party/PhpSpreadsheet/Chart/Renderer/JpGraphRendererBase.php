    ...
    private function renderLegend(): void
    {
        ...
        if ($legend !== null) {
            ...
            switch ($legendPosition) {
                case 'r':
                    $this->graph->legend->SetPos(0.01, 0.5, 'right', 'center');                     $this->graph->legend->SetColumns(1);

                    break;
                case 'l':
                    $this->graph->legend->SetPos(0.01, 0.5, 'left', 'center');                     $this->graph->legend->SetColumns(1);
                ...
                case 'b':
                    ...
                    break;
                default:
                    $this->graph->legend->SetPos(0.01, 0.01, 'right', 'top');                     $this->graph->legend->SetColumns(1);
