...
class Content extends WriterPart
{
        ...
        public function write(): string
    {
        ...
        $objWriter->writeAttribute('xmlns:ooo', 'http:        $objWriter->writeAttribute('xmlns:ooow', 'http:        $objWriter->writeAttribute('xmlns:oooc', 'http:        $objWriter->writeAttribute('xmlns:dom', 'http:        $objWriter->writeAttribute('xmlns:xforms', 'http:        $objWriter->writeAttribute('xmlns:xsd', 'http:        $objWriter->writeAttribute('xmlns:xsi', 'http:        $objWriter->writeAttribute('xmlns:rpt', 'http:        $objWriter->writeAttribute('xmlns:of', 'urn:oasis:names:tc:opendocument:xmlns:of:1.2');
        $objWriter->writeAttribute('xmlns:xhtml', 'http:        $objWriter->writeAttribute('xmlns:grddl', 'http:        $objWriter->writeAttribute('xmlns:tableooo', 'http:        $objWriter->writeAttribute('xmlns:field', 'urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0');
        $objWriter->writeAttribute('xmlns:formx', 'urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0');
        $objWriter->writeAttribute('xmlns:css3t', 'http:        $objWriter->writeAttribute('office:version', '1.2');
            ...
            switch ($cell->getDataType()) {
                ...
                case DataType::TYPE_INLINE:
                    ...
                    if (empty($url)) {
                        ...
                        $sheets = 'sheet:                        $lensheets = strlen($sheets);
